  ...
  return (
    <>
      ...
      {modules.length > 0 && modules.every((m) => m.status === 'completed') && (
        <div className="w-full p-4 rounded-2xl bg-gradient-to-br from-[#8B7CF6]/20 to-[#38BDF8]/10 border border-[#8B7CF6]/40 shadow-lg flex flex-col gap-2.5 animate-in fade-in">
