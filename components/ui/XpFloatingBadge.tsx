    ...
    <AnimatePresence>
      {delta && (
        <motion.div
          ...
          animate={{ opacity: 1, y: -8, scale: 1.05 }}
          exit={{ opacity: 0, y: -24, scale: 0.95 }}
          transition={{ duration: 0.5, ease: 'easeOut' }}
          className={`pointer-events-none absolute -top-8 right-0 inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-baloo font-extrabold tracking-wide shadow-lg select-none z-20 ${
            delta.type === 'gain'
